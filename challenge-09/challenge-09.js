...
(function() {
    ...
    */
    let subtracion = calculator(5, 3);
    let multiplication = calculator(10, 7);
    let division = calculator(100, 4);
    let mod = calculator(10, 3);
    ...
    */
    ...
    console.log(subtracion(function (number1, number2) {
        return number1 - number2;
    }))
