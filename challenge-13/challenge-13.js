(function () {
    ...
    */
    ...
    const arr = [1, true, 'gustavo', {lastname: 'barretto', age: 30}, 2.5, function () { return 'Olá, ninja!'}]
    ...
    */
    ...
    brasil.forEach( (st, idx) => {

        return newBrasil.push({id: idx, state: st});
    ...
    */
    ...
    console.log(brasil.every( (states) => { return states.length > 7; }) ?
                'Sim, todos os estados tem mais de 7 letras!' :
                'Nem todos os estados tem mais de 7 letras!'            
    )
    ...
    */
    ...
    console.log(brasil.some( state => { return state == 'Ceará';}) ?
                'Ceará está incluído!' :
    ...
    */
    ...
    newBrasil.map( st => {
        ...
        st['state'] = st['state'] + ' pertence ao Brasil.';
    ...
    */
    ...
    const filter = newBrasil.filter( state => {
        return state['id'] % 2 == 0 ? state['state'] : '';
    })
